...
/**
 * Abstract Page factory for Create/Edit "Admin > Simulator > Simulator
 * Category" pages that can be found in JMedSIM.<br>
 ...
 *
 */
public abstract class ModifySimulatorCategoryBase extends ModifyBase {
	/**
	 ...
	 * Extends ModifyBase
	 */
	public ModifySimulatorCategoryBase(String regexURL) {
		super(regexURL);
	}

	@FindBy(id = "SimulatorCategoryName")
	WebElement categoryTextfield;

	/**
	 * Set text in field "Category".
	 * 
	 * @param text
	 */
	public void setCategory(String text) {
		AutomationHelper.printMethodName();
		AutomationHelper.setTextField(categoryTextfield, text);
	}
	...
	public String readCategory() {
		AutomationHelper.printMethodName();
		return categoryTextfield.getAttribute("value");
	}

	/**
	 * Reads Category error message (if any)
	 * 
	 * NOTE: returns empty string if no message
	 * 
	 * @return String
	 */
	public String readCategoryErrorMessage() {
		AutomationHelper.printMethodName();
		return readErrorMessageForField(categoryTextfield.getAttribute("id"));
	}

	@FindBy(id = "SimulatorCategoryDescription")
