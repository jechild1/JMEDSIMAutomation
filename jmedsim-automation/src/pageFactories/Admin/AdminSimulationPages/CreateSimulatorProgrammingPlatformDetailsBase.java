...
/**
 * Abstract Page factory for the Details/Delete page of Admin > Simulation > Simulator Programming Platform
 ...
 *
 */
public class CreateSimulatorProgrammingPlatformDetailsBase extends DetailsBase {
	 ...
	 * 
	 */
	public CreateSimulatorProgrammingPlatformDetailsBase(String regexURL) {
		super(regexURL);
	}
